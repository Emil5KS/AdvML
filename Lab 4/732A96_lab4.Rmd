...
All plots are avaliable [at my GitHub accound](http://example.com) in form of gifs. 
...
For the standard deviation equal to 50 we have a harder time finding the true state but it is still a good aproximation after a couple of itterations. 

For the special case with equal weights the predictions are useless, but since we basicly only use prior information and never update it. 
